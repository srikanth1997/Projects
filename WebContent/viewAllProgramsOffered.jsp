			...
			<table class="table">
				<thead>
					<tr>
						...
						<th bgcolor="#c2c2d6">Eligibility</th>
						<th bgcolor="#c2c2d6">Duration</th>
						<th bgcolor="#c2c2d6">Degree Certificate</th>
				...
				<tbody>
					...
					<c:forEach var="program" items="${programsList}">
						<tr>
							...
							<td>${program.degreeCertificate}</td>

							<c:if test="${program.checkprogram eq false}">
								<td>NA</td>
							</c:if>
							<c:if test="${program.checkprogram eq true}">
								<td><a href="demo.obj?id=${program.programID}">Apply</a></td>
							</c:if>
						</tr>
					</c:forEach>
