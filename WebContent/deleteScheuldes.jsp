  ...
  <table class="table">
    <thead>
      <tr>
		...
		<th bgcolor="bisque">sessionPerWeek</th>
...
<c:forEach var="programsList" items="${schedulelist}">
<tr>
			<td>${programsList.programId}</td>
			<td>${programsList.programName}</td>
			<td>${programsList.location}</td>
			<td>${programsList.startDate}</td>
			<td>${programsList.endDate}</td>
			<td>${programsList.sessionPerWeek}</td>
			<td><a href="scheduleDelete.obj?programId=${programsList.programId}">delete</a></td>
</tr>
</c:forEach>
