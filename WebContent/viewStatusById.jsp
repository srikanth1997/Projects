...
<body>
	...
	<div class="container">
		...
		<c:if test="${ statusBean.status eq status }">
			  <h1>Application Confirmed!!</h1>
			</c:if>
		<c:if test="${ statusBean.status eq status2 }">
			  <h1>Application Accepted!!</h1>
			  <br>
			  <h1>Interview Date : ${statusBean.dateOfInterview} </h1>
			</c:if>	
			
		<c:if test="${ statusBean.status eq status1 }">
