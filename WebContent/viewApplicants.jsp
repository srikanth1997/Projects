...
<title>Applicants</title><meta name="viewport" content="width=device-width, initial-scale=1">
...
<tr>
			...
			<td><a href="confirm.obj?appId=${applicantList.applicationId }">confirm</a></td>
			 </c:if>
			  ...
			  <c:if test= "${applicantList.status eq status}">
			<td><a href="reject.obj?appId=${applicantList.applicationId }">Reject</a></td>
			</c:if>
